...
export const AlreadyReported = Template.bind({})
AlreadyReported.parameters = {
  layout: 'fullscreen',
}
AlreadyReported.args = {
...
export const AlreadyReportedWithoutImage = Template.bind({})
AlreadyReportedWithoutImage.parameters = {
  layout: 'fullscreen',
}
AlreadyReportedWithoutImage.args = {
  alreadyReported: true,
  title: 'Hängende Blätter',
  description:
    'Hängende Blätter könnten ein Mangel am Wasser andeuten. Melde es bitte wenn diesen Baum hängende Blätter hat.',
