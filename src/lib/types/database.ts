// types generated by supabase cli don't edit manually
export type Json =
  | string
  | number
  | boolean
...
export interface Database {
  public: {
    Tables: {
      ...
      soil: {
        Row: {
          antro_bg: number | null
          antro_bg_bez: string | null
          aus_bg: number | null
          aus_bg_bez: string | null
          ausgangsm: string | null
          bart_gr: number | null
          bform_ka5: string | null
          bform_ka5_bez: string | null
          bg_alt: string | null
          bnbg_ob: string | null
          bnbg_ob_h: string | null
          bnbg_ob_h_bez: string | null
          bnbg_ub: string | null
          bnbg_ub_bez: string | null
          bnbg_ub_h: string | null
          bnbg_ub_h_bez: string | null
          bngb_ob_bez: string | null
          boges_neu5: number | null
          btyp: string | null
          btyp_ka3: string | null
          btyp_ka3_bez: string | null
          btyp_ka4: string | null
          btyp_ka4_bez: string | null
          created_at: string | null
          flur: number | null
          flurklasse: number | null
          flurklasse_bez: string | null
          flurstufe: number | null
          flurstufe_bez: string | null
          geomeinh: number | null
          geomeinh_bez: string | null
          geometry: unknown | null
          id: string
          nutz: number | null
          nutz_bez: string | null
          nutzgenese: string | null
          schl5: number | null
          sg_klas: number | null
          sg_klas_bez: string | null
          sg_ob: string | null
          sg_ob_bez: string | null
          sg_ub: string | null
          sg_ub_bez: string | null
          torf_bg: number | null
          torf_bg_bez: string | null
          torf_klas: number | null
          torf_klas_bez: string | null
          torf_ob: string | null
          torf_ob_bez: string | null
          torf_ub: string | null
          torf_ub_bez: string | null
          updated_at: string | null
          vgradstufe: number | null
          vgradstufe_bez: string | null
        }
        Insert: {
          antro_bg?: number | null
          antro_bg_bez?: string | null
      ...
      trees: {
        Row: {
          ...
          kronedurch: number | null
          lat: number | null
          lng: number | null
          namenr: string | null
          pflanzjahr: number | null
          stammumfg: number | null
          standalter: number | null
          standortnr: string | null
          street_tree: boolean | null
          strname: string | null
          updated_at: string | null
          zusatz: string | null
        }
      ...
      weather_stations: {
        Row: {
          ...
          lat: number | null
          lon: number | null
          stationshoehe: number | null
          stationsname: string | null
